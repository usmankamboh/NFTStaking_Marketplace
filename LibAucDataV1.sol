...
// library that works with data field of Auction struct
library LibAucDataV1 {
    bytes4 constant public V1 = bytes4(keccak256("V1"));

    // struct of Auction data field, version 1
    struct DataV1 {
        // auction originFees
        uint originFee;
        // auction duration
    ...
    // returns parsed data field of an Auction (so returns DataV1 struct)
